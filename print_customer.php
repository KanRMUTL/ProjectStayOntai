...
<body>
    ...
    <table class="table table-bordered">
        ...
        <thead>
            ...
            <tr>
                ...
                <th class="text-center" width="2500">E-mail</th>
                <th class="text-center" width="1500">เบอร์โทรศัพท์</th>
            </tr>
        </thead>
        <tbody>
            <?PHP
            $sql = "SELECT user_id,user_email,user_titlename,user_name,user_lastname,user_tel FROM tb_user WHERE user_type = 9";
    ...
    <p class="sumcus">จำนวนลูกค้าทั้งหมด <?php echo count($list)?> คน</p>
    <hr style="border-bottom: 1px solid; position: relative;">
    <br>
