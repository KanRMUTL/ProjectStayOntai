...
<body>
    ...
    <table class="table table-bordered">
        ...
        <tbody>
            ...
            INNER JOIN tb_room d ON a.room_id = d.room_id INNER JOIN tb_homestay e ON d.homestay_id = e.homestay_id INNER JOIN tb_user u ON e.user_id = u.user_id WHERE  MONTH(booking_date) = '{$mm}' AND YEAR(booking_date) = '{$yy}'AND e.user_id='{$uid}' AND booking_detail_status != 6";
