                        ...
                        <tbody>
                              <?PHP foreach ($result as $key => $row) { ?>
                               ...
                               <!-- Mobile Screen -->   
                                    ...
                                    <a href="../print_homestay_checkout.php?start=<?=$start;?>&end=<?=$end;?>"  class="btn btn-warning d-none d-sm-inline">ปริ้นรายงานรายวัน</a>
                                    <a href="../print_homestay_mount_checkout.php?start=<?=$start;?>&end=<?=$end;?>" class="btn btn-warning d-none d-sm-inline">ปริ้นรายงานรายเดือน</a>
