    ...
    <div class="col-sm-9 col-lg-9">
        <div id="register-wraper">
            <div id="register-form" style="position: relative;">
                ...
                <legend>จัดการอัมบั้มOTOP: <?=$title['otop_name'];?></legend>
                ...
                <div class="tb_all">
                    <form action="process/otop_img_process.php" enctype="multipart/form-data" method="post">
                            ...
                            <?PHP foreach ($list as $row){ ?>
                                <div class="col-md-2">
                                    <div style="margin-bottom: 15px;">
                                        ...
                                        <p>
                                            <a
                                                href="process/delete.php?table=tb_otoppic&ff=otoppic_id&id=<?= $row['otoppic_id']; ?>"
