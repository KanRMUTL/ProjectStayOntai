                        ...
                        <table class="table table-striped table-bordered table-hover">
                            ...
                            <tbody>
                                ...
                                <?php }elseif(isset($_GET["year"])){ ?>
                                    ...
                                    <a href="../print_checkout.php?start=<?=$start;?>&end=<?=$end;?>" class="btn btn-warning">ปริ้นรายงานรายวัน</a>
                                    <a href="../print_mount_checkout.php?yy=<?=$yy;?>&mm=<?=$mm;?>" class="btn btn-warning">ปริ้นรายงานรายเดือน</a>
