    ...
    <div class="col-sm-9 col-lg-9">
        <div id="register-wraper">
            <div class="form_all">
                ...
                <legend>จัดการบัญชี : รายรับ</legend>

                <form role="form" action="process/ledger_process_income.php" method="post"
                    ...
                    <p align="center">
                        ...
                        <a href="ledger_income.php?type=1&active=1" class="btn btn-warning">ย้อนกลับ</a>
                    </p>
                </form>
            </div>
        </div>
