...
<!----------------------------------------- ค้นหาเดือนตาม เดือน------------------------>
                    ...
                    <a href="../print_homestay_checkin.php?start=<?=$start;?>&end=<?=$end;?>" class="btn btn-warning">ปริ้นรายงานรายวัน</a>
                    <a href="../print_homestay_mount_checkin.php?yy=<?=$yy;?>&mm=<?=$mm;?>" class="btn btn-warning">ปริ้นรายงานรายเดือน</a>
                    <br>
                    <br>
                </div>
            </div>
