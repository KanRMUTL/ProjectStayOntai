    ...
    <div class="col-sm-9 col-lg-9">
        <div id="register-wraper">
            <div id="register-form" style="position: relative;">
                ...
                <legend>จัดการอัมบั้มข่าวสาร : <?=$title['news_title'];?></legend>
                ...
                <div class="tb_all">
                    <form action="process/news_img_process.php" enctype="multipart/form-data" method="post">
                            ...
                            <?PHP foreach ($list as $row){ ?>
                                <div class="col-md-2">
                                       <div style="margin-bottom: 15px;">
                                           ...
                                           <p>
                                               <a
                                                   href="process/delete.php?table=tb_newspic&ff=newspic_id&id=<?= $row['newspic_id']; ?>"
