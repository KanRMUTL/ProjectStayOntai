    ...
    <div class="col-sm-9 col-lg-9">
        <div id="register-wraper">
            <div class="form_all">
                ...
                <form role="form" action="process/editprofile_process.php" method="post"
                        ...
                        <div class="row">
                            <div class="col-md-2">
                                ...
                                <select name="user_titlename" class="form-control" required>
                                    <option <?=$title == 'นาย' ? "selected":"";?> value="นาย">นาย</option>
                                    <option <?=$title == 'นาง' ? "selected":"";?> value="นาง">นาง</option>
                                    <option <?=$title == 'นางสาว' ? "selected":"";?> value="นางสาว">นางสาว</option>
                                </select>
                            </div>
