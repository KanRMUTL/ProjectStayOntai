    ...
    <table class="table table-bordered">
        ...
        <thead>
            ...
            <tr>
                ...
                <th class="text-center" width="2100">ห้อง</th>
                <th class="text-center" width="3000">ผู้จอง</th>
                <th class="text-center" width="500">เบอร์โทรศัพท์</th>
                <th class="text-center" width="1500">เช็คอิน</th>
            </tr>
        </thead>
        <tbody>
          <?PHP
